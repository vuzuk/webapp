...
class Photos extends Component {
    ...
    makeList = (imgs) => {
        return imgs.map((img, i) => {
            return (
                <Modal size="large" className="photo-modal" open={this.state.modal === i} onClose={this.handleModalClose} trigger={
                    ...
                    <Modal.Content>
                        ...
                        <Image wrapped fluid src={`${img.image}`} />
    ...
    render() {
        return (
            <div id="photo-slides">
                ...
                <section id="photos">
                    {this.makeList(this.state.imgs.slice(0,16))}
                </section>
            </div>
        )
    }
